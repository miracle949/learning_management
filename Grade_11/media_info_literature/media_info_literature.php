...
<div class="module-title">
    <h1>Media Information Literature</h1>
...
<div class="module-parent-progress">
    ...
    <div class="module-progress" data-module-id="module1">
        <h3>Media Information Literature</h3>
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=media_info_literature&module=module1">Continue learning <i
    ...
    <div class="module-progress" data-module-id="module2">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=media_info_literature&module=module2">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
    ...
    <div class="module-progress" data-module-id="module3">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=media_info_literature&module=module3">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
