...
<div class="module-title">
    <h1>Computer System Servicing</h1>
...
<div class="module-parent-progress">
    ...
    <div class="module-progress" data-module-id="module1">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=css_11&module=module1">Continue learning <i
    ...
    <div class="module-progress" data-module-id="module2">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=css_11&module=module2">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
    ...
    <div class="module-progress" data-module-id="module3">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=css_11&module=module3">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
