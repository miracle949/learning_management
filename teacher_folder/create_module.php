            ...
            <main>
                            ...
                            <?php if (!empty($subject['subject_image'])): ?>
                                <div class="card-header" style="padding:0;overflow:hidden;">
                                    <img src="/learning_management/<?= htmlspecialchars($subject['subject_image']) ?>"
                                        alt="subject image"
                                        style="width:100%;height:100%;object-fit:cover;border-radius:0px 0px 0 0;">
                                </div>
                            <?php else: ?>
                            ...
                            <div class="card-body">
                                <div class="card-text">
                                    ...
                                    <?php if (!empty($subject['grade_name'])): ?>
                                        <small
                                            style="color:#16a34a;font-weight:600;font-size:14.5px;display:block;margin-bottom:0px;">
                ...
                <?php else: ?>
                    <div style="padding:2rem;">
                        ...
                        <a href="/learning_management/public/?url=modules_teacher">← Back to subjects</a>
                    </div>
                <?php endif; ?>

                <div class="body">
                    <form action="/learning_management/public/?url=save_module" method="POST"
