                ...
                <div class="module-header-body">
                    ...
                    <div class="module-header-right">
                        <div class="module-stat">
                            ...
                            <span><span class="module-stat-num">
                                    <?= $totalLessons ?>
                                </span> Lessons</span>
                        </div>
                        <div class="module-stat">
                                            ...
                                            <div class="fc-item" onclick="this.classList.toggle('flipped')">
                                                <div class="fc-inner">
                                                    <div class="fc-front">
                                                        ...
                                                        <span class="fc-text">
                                                            <?= htmlspecialchars($fc['card_front']) ?>
                                                        </span>
                                                ...
                                                <div>
                                                    ...
                                                    <?php if (!empty($act['instructions'])): ?>
                                                        <p class="activity-intro-desc">
                                                            <?= htmlspecialchars($act['instructions']) ?>
                                                        </p>
                                                    <?php endif; ?>
                                                    <div class="activity-meta-pills">
                                                        ...
                                                        <span class="meta-pill pill-green">⭐
                                                            <?= (int) $act['total_points'] ?> pts
                                                        </span>
                                                        <?php if ($isSubmitted): ?>
                                                            <span class="meta-pill pill-green"><i class="fa fa-check"></i>
                                                                Submitted</span>
                                                        <?php else: ?>
                                                            <span class="meta-pill pill-orange"><i class="fa fa-pencil-alt"></i> Answer
                                                                required</span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <?php if ($isSubmitted): ?>
                                                ...
                                                <?php foreach ($questions as $qi => $q): ?>
                                                    <div class="activity-question">
                                                        ...
                                                        <?php else: ?>
                                                            <div
                                                                style="background:#f9fafb;border:1.5px solid #e5e7eb;border-radius:8px;padding:12px 14px;font-size:14px;color:#555;font-style:italic;">
                            ...
                            <?php if (!empty($quizData)): ?>
                                <div class="lesson-section">
                                                    ...
                                                    <div class="q-choices">
                                                        ...
                                                        foreach ($ch as $key => $val):
                                                            ...
                                                            <div class="q-choice" style="pointer-events:none;<?= $bs ?>">
                                                                <span class="choice-letter" style="<?= $ls ?>">
                                                                    <?= $qLtrs[$li++] ?>
                                                                </span>
                                                                <?= htmlspecialchars($val) ?>
                                                                <?= $ic ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <!-- QUIZ NAV -->
                                        <div class="quiz-nav">
                                            <span class="quiz-status" id="unified_status">0 /
                                                <?= $grandTotal ?> answered
                                            </span>
