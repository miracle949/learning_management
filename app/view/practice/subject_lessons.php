...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="rightbar">
            ...
            <?php
            // ── Safe defaults — prevents warnings when static module is loaded ──
// For static modules, the controller won't set these; JS takes over rendering.
            $isStatic = isset($_GET['id']) && str_starts_with($_GET['id'] ?? '', 'static_');

            $lessons = $lessons ?? [];
            $lesson = $lesson ?? null;
            $module = $module ?? [];
            $lessonId = $lessonId ?? null;
            $moduleId = $moduleId ?? ($_GET['id'] ?? '');
            ...
            <?php
            // ── Detect static module early — skip DB variables if so ──
            $isStatic = isset($_GET['id']) && str_starts_with($_GET['id'], 'static_');
            ...
            // Only calculate these for non-static modules
            if (!$isStatic) {
                $currentIndex = 1;
                $prevLessonId = null;
                $nextLessonId = null;
                ...
                <div class="module-header-body">
                    ...
                    <div class="module-header-right">
                        ...
                        <?php else: ?>
                            <div class="module-stat">
                                <i class="fa fa-book-open"></i>
                                <span><span class="module-stat-num" id="static-total-lessons">–</span> Lessons</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="body-lessons">
                ...
                <div class="sidebar-lessons">
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            <?php if (!$isStatic): ?>
                                <?php foreach ($lessons as $i => $l): /* ...existing loop... */ ?>
                                <?php endforeach; ?>
                            <?php endif; ?>
                            <!-- static_lesson_renderer.js fills this for static modules -->
                        </ul>
                    </div>
                </div>
    ...
    <script src="../javascript_folder/static_lessons.js"></script>
    <script src="../javascript_folder/static_lesson_renderer.js"></script>
