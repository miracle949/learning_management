    ...
    <div class="container-fluid p-0">
        ...
        <div class="rightbar">
            ...
            <style>
                ...
                .activity-answer:focus { border-color: #f59e0b; }
                ...
                /* ── READ-ONLY REVIEW after submission ── */
                .review-choice {
                    display: flex;
                    align-items: center;
                    gap: 10px;
                ...
                .back-module { padding: 1rem; }
                .back-module a { text-decoration: none; font-size: 14.5px; color: var(--green); }
            </style>
            ...
            <div class="back-module">
                <a href="/learning_management/public/?url=modules&subject=<?= urlencode($subject) ?>">
                            ...
                            <div class="view-lessons-body" style="padding: 10px 1.9rem;">
                                        ...
                                        <div class="lesson-section">
                                            ...
                                            <?php foreach ($videos as $vid): ?>
                                                    <div class="video-card">
                                                        <iframe src="<?= htmlspecialchars(youtubeEmbed($vid['file_path'])) ?>"
                                            ...
                                            <?php foreach ($activityData as $actId => $data):
                                                ...
                                                ?>
                                                    ...
                                                    <div class="activity-block">
                                                        ...
                                                        <div class="activity-intro">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="activity-meta-pills">
                                                                    ...
                                                                    <?php if ($isSubmitted): ?>
                                                                            <span class="meta-pill pill-green"><i class="fa fa-check"></i> Submitted</span>
                                                                    <?php else: ?>
                                                                            <span class="meta-pill pill-orange"><i class="fa fa-pencil-alt"></i> Answer required</span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                    ...
                                                                                    foreach ($ch as $key => $val):
                                                                                        ...
                                                                                        ?>
                                                                                            <div class="review-choice"
                                                                                                style="<?= $isCorrect ? 'border-color:#22c55e;background:#f0fdf4;' : '' ?>">
                                                        ...
                                                        <?php else: ?>
                                                                <!-- ══ NOT YET SUBMITTED — answers collected on Finish ══ -->
                                                                <div class="activity-answers-wrapper"
                                                                     data-activity-id="<?= (int) $actId ?>">
                                                                    ...
                                                                    <?php foreach ($questions as $qi => $q): ?>
                                                                            <div class="activity-question">
                                                                                ...
                                                                                <?php if ($q['question_type'] === 'multiple_choice'): ?>
                                                                                        <!-- Hidden input keeps selected key in sync -->
                                                                                        <input type="hidden"
                                                                                               id="mc_hidden_<?= (int) $q['id'] ?>"
                                                                                               value="">
                                                                                        <?php
                                                                                        $ltrs = ['A', 'B', 'C', 'D'];
                                                                                        $ch = ['a' => $q['choice_a'], 'b' => $q['choice_b'], 'c' => $q['choice_c'], 'd' => $q['choice_d']];
                                ...
                                <?php if (!empty($quizData)): ?>
                                        <div class="lesson-section">
                                                                ...
                                                                <div style="width:100%;">
                                                                    ...
                                                                    <div class="activity-meta-pills"
                                                                        ...
                                                                        <p class="result-label" style="margin:0;font-size:11px;">
                                                                            You scored <?= (int) $data['result']['score'] ?> out of <?= (int) $data['result']['total'] ?>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="q-card">
                                                                        ...
                                                                        <div class="q-choices">
                                                                            ...
                                                                            foreach ($ch as $key => $val):
                                                                                ...
                                                                                if ($isCorrect) {
                                                                                    $bs = 'border-color:#22c55e;background:#f0fdf4;';
                                                                                    $ls = 'background:#22c55e;color:#fff;';
                                                                                    $ic = '<i class="fa fa-check" style="margin-left:auto;color:#22c55e;"></i>';
                                                                                } elseif ($isWrong) {
                                                                                    $bs = 'border-color:#ef4444;background:#fef2f2;';
                                                                                    $ls = 'background:#ef4444;color:#fff;';
                                                                                    $ic = '<i class="fa fa-times" style="margin-left:auto;color:#ef4444;"></i>';
                                                                                } else {
                                                                                    $bs = 'border-color:#e5e7eb;';
                                                                                    $ls = 'background:#f1f5f9;color:#555;';
                                                                                    $ic = '';
                                                                                }
                                                                                ?>
                                            ...
                                            <?php else: ?>
                                                    <!-- ── QUIZ NOT DONE — paginated interactive ── -->
                            ...
                            <div class="view-lessons-footer" style="padding: 0 30.4px;">
                                ...
                                <nav aria-label="Lesson navigation">
                                    <ul class="pagination m-0">
                                        <li class="page-item">
                                            <?php if ($prevLessonId): ?>
                                                    <a class="page-link" href="<?= lUrl($subject, $moduleId, $prevLessonId) ?>" id="prevBtn">
                    ...
                    <script>
                        (function () {
                            ...
                            function showPage(page) {
                                document.querySelectorAll('.unified-q-card').forEach(function(el) { el.style.display = 'none'; });
                                document.querySelectorAll('.unified-q-card[data-page="' + page + '"]').forEach(function(el) { el.style.display = 'block'; });
                            ...
                            window.unifiedPageNav = function(dir) {
                                ...
                                document.querySelectorAll('.unified-q-card').forEach(function(el) { el.style.display = 'none'; });
                                document.querySelectorAll('.unified-q-card[data-page="' + newPage + '"]').forEach(function(el) { el.style.display = 'block'; });
