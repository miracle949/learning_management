    ...
    <div class="module-parent-progress">
        ...
        <div class="module-progress" data-module-id="module1">
            ...
            <div class="module-progress-body">
                ...
                <div class="footer-bar">
                    <a href="/learning_management/public/?url=subject_lessons&subject=entrep&module=module1">Continue
        ...
        <div class="module-progress" data-module-id="module2">
            ...
            <div class="module-progress-body">
                ...
                <div class="footer-bar">
                    <a href="/learning_management/public/?url=subject_lessons&subject=entrep&module=module2">Continue
                        learning <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="module-progress" data-module-id="module3">
            ...
            <div class="module-progress-body">
                ...
                <div class="footer-bar">
                    <a href="/learning_management/public/?url=subject_lessons&subject=entrep&module=module3">Continue
                        learning <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
