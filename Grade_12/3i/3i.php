...
<div class="module-title">
    <h1>Inquiries, Investigation and Immersion</h1>
    <p>CSS 12-1</p>
</div>
...
<div class="module-parent-progress">
    ...
    <div class="module-progress" data-module-id="module1">
        <h3>Inquiries, Investigation and Immersion</h3>
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=3i&module=module1">Continue learning <i
    ...
    <div class="module-progress" data-module-id="module2">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=3i&module=module2">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
    ...
    <div class="module-progress" data-module-id="module3">
        ...
        <div class="footer-bar">
            <a href="/learning_management/public/?url=subject_lessons&subject=3i&module=module3">Continue learning <i
                    class="fa fa-arrow-right"></i></a>
        </div>
    </div>
