        ...
        <div class="rightbar">
            ...
            <main>
                ...
                <?php if ($subjectInfo): ?>
                    ...
                    <!-- Back button — goes back to the super admin activities page -->
                    <a href="/learning_management/public/?url=activities" class="back-breadcrumb">
                        ...
                        <div class="learning-module">
                            ...
                            <?php else: ?>
                                <?php foreach ($modules as $mod):
                                    ...
                                    // Use the TeacherModel (passed from controller) to get lessons
                                    $firstLesson = $teacherModel->getLessonsByModule($mod['id']);
                                    $firstLessonId = !empty($firstLesson) ? (int) $firstLesson[0]['id'] : 0;

                                    // Link to super admin lessons view
                                    $lessonsUrl = "/learning_management/public/?url=subject_lessons_admin&subject_id={$subjectId}&id={$mod['id']}"
                ...
                <?php else: ?>
                    <div style="padding:2rem;">
                        ...
                        <a href="/learning_management/public/?url=activities">← Back to Activities</a>
                    </div>
                <?php endif; ?>
